...
# Define Variables
mservice2 = "https://mservice2-0e54f5020a6762440.7d67968.vpc-lattice-svcs.ap-southeast-1.on.aws"
mservice2sec = "https://mservice2-0e54f5020a6762440.7d67968.vpc-lattice-svcs.ap-southeast-1.on.aws/secure"
...
def app1resp():
    ...
    try:    
        ...
        if not requestdata:
             # Handle Health Check or Browser case
             return "Healthy", 200
             
        # requestdata = request.json # Removed strict check
